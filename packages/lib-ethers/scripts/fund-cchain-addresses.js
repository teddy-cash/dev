...
// const cChainBlockchainID = utils_1.Defaults.network["12345"].C.blockchainID;
 const cChainBlockchainID = '2CA6j5zYzasynPsFeNoqWkmTCt3VScMvXUZHbfDJ8k3oGzAPtU';
console.log(cChainBlockchainID);
...
const xChainBlockchainID = '2eNy1mUFdmaxXNj1eQHUe7Np4gju9sJsEtWQ4MX3ToiNKuADed';
...
const main = async () => {
  ...
  console.log("avaxAssetID", avaxAssetID);

...
contract LQTYToken is CheckContract, ILQTYToken {
    ...
    string internal constant _NAME = "PTEDDY";
    string internal constant _SYMBOL = "PTEDDY";
    ...
    constructor(
        ...
        // Allocate the remainder to the LQTY Multisig: (100 - 27 - 3 - 50) million = 20 million

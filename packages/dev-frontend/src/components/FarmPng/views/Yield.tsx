      ...
      <InfoIcon
        tooltip={
          <Card variant="tooltip" sx={{ minWidth: ["auto", "352px"] }}>
            <Paragraph>
              An <Text sx={{ fontWeight: "bold" }}>estimate</Text> of the TEDDY return on staked PGL
              LP tokens. The farm runs for 4-weeks, and the return is relative to the time remaining.
            </Paragraph>

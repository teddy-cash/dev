...
const selector = ({ p3TotalStakedUniTokens }: LiquityStoreState) => ({ p3TotalStakedUniTokens });

export const Staking: React.FC = () => {
  const { dispatchEvent } = useFarmView();
  const { p3TotalStakedUniTokens: totalStakedUniTokens } = useLiquitySelector(selector);
  ...
  return (
    <Card>
      <Heading>
        Trader Joe {POOL3} Liquidity Farm

...
export const Description: React.FC<DescriptionProps> = ({ amount }) => {
  ...
  return (
    <ActionDescription>
      {isWithdrawing && (
        <Transaction id={transactionId} send={liquity.tjUnstakeUniTokens.bind(liquity, amountChanged)}>
          <Text>
      ...
      {!isWithdrawing && (
        <Transaction id={transactionId} send={liquity.tjStakeUniTokens.bind(liquity, amountChanged)}>
          <Text>
